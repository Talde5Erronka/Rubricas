<?php
	...
	$url = "'".base_url()."<?php echo base_url(); ?>index.php/GrupoCompetencia'";
...
<div>
	<?php echo form_open('<?php echo base_url(); ?>index.php/GrupoCompetencia/actualizar/'.$grupocompetencias->result()[0]->ID_GrupoCompetencia,$form); ?>
