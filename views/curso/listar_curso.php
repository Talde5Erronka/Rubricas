	...
	<script type="text/javascript">
		...
		function mostrartabla() {
	  		...
	  		$.get('<?php echo base_url(); ?>index.php/Curso/Cursos_ajax', function(datos){
				...
				$("#sacardatos").append("<tr><td><input type='checkbox' name='checkbox[]' id='"+valor.ID_Curso+"'onClick='gurdar(this.id)'></td><td><a href=<?php echo base_url(); ?>index.php/Curso/editar/"+valor.ID_Curso+">"+valor.ID_Curso+"</a></td><td><a href=<?php echo base_url(); ?>index.php/Curso/editar/"+valor.ID_Curso+">"+valor.COD_Curso+"</a></td>")
				});
			});
		}
