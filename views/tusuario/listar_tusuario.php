			...
			//Manda los valores a la función de filtrar y hace la función con lo que devuelve
		  	$.get('<?php echo base_url(); ?>index.php/Tusuario/Tusuarios_ajax',function(datos){
				...
				$.each(datos2,function(indice,valor){
					...
					$("#sacardatos").append( 
						"<tr><td><input type='checkbox' name='checkbox[]' id='"+valor.ID_TUsuario+"'onClick='gurdar(this.id)'></td><td><a href=<?php echo base_url(); ?>index.php/TUsuario/editar/"+valor.ID_TUsuario+">"+valor.ID_TUsuario+"</a></td><td><a href=<?php echo base_url(); ?>index.php/TUsuario/editar/"+valor.ID_TUsuario+">"+valor.DESC_TUsuario+"</a></td>"
					)
				});
			});
		};
