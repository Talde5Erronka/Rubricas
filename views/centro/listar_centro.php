			...
			//Manda los valores a la función de filtrar y hace la función con lo que devuelve
		  	$.get('<?php echo base_url(); ?>index.php/Centro/Centros_ajax',function(datos){
				...
				$.each(datos2,function(indice,valor){
					...
					$("#sacardatos").append( 
						"<tr><td><input type='checkbox' name='checkbox[]' id='"+valor.ID_Centro+"'onClick='gurdar(this.id)'></td><td><a href=Centro/editar/"+valor.ID_Centro+">"+valor.ID_Centro+"</a></td><td><a href=Centro/editar/"+valor.ID_Centro+">"+valor.COD_Centro+"</a></td><td><a href=Centro/editar/"+valor.ID_Centro+">"+valor.DESC_Centro+"</a></td>"
					)
				});
			});
	};
