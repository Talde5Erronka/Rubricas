			...
			//Manda los valores a la función de filtrar y hace la función con lo que devuelve
		  	$.get('<?php echo base_url(); ?>index.php/Reto/Retos_ajax',function(datos){
				...
				$.each(datos2,function(indice,valor){
					...
					$("#sacardatos").append( 
						"<tr><td><input type='checkbox' name='checkbox[]' id='"+valor.ID_Reto+"'onClick='gurdar(this.id)'></td><td><a href=<?php echo base_url(); ?>index.php/Reto/editar/"+valor.ID_Reto+">"+valor.ID_Reto+"</a></td><td><a href=<?php echo base_url(); ?>index.php/Reto/editar/"+valor.ID_Reto+">"+valor.COD_Reto+"</a></td><td><a href=<?php echo base_url(); ?>index.php/Reto/editar/"+valor.ID_Reto+">"+valor.DESC_Reto+"</a></td>"
					)
				});
			});
		};
