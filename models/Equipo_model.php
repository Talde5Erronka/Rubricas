<?php
	...
	class Equipo_model extends CI_Model{
		...
		public function obtener_equipos_por_usuario($ID_Usuario){
			include ("conexion_2.php");
			...
			if($ID_Usuario!=""){
				$sql = "SELECT DISTINCT Equipo.ID_Equipo FROM Equipo, Equipo_Usuario, Usuario WHERE Equipo.ID_Equipo=Equipo_Usuario.ID_Equipo AND Equipo_Usuario.ID_Usuario=$ID_Usuario";
			}
			else{
				$sql = "";
			}
